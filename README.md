...
The following is a set of guidelines for contributing to the [translated content of MDN Web Docs](https://github.com/Unity-Billal-mesloub/translated-content), which is hosted within the [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub) on GitHub.
...
If you want to just find a task and jump in, search by the labels `l10n-fr`, `l10n-ja`, `l10n-ko`, `l10n-pt-br`, `l10n-ru`, `l10n-zh` and `l10n-es` in this repo's [issues list](https://github.com/Unity-Billal-mesloub/translated-content/issues), 
## Code of Conduct
